 ...
 *
 * Be sure to replace all instances of 'traa_' with your project's prefix.
 ...
 */
function traa_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function traa_hide_if_no_cats( $field ) {
 ...
 */
function traa_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function traa_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function traa_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'traa_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function traa_register_demo_metabox() {
	/**
	 * Sample metabox to demonstrate each field type included
	 */
	$cmb_demo = new_cmb2_box( array(
		'id'            => 'traa_demo_metabox',
		'title'         => esc_html__( 'Test Metabox', 'cmb2' ),
		'object_types'  => array( 'page' ), // Post type
		// 'show_on_cb' => 'traa_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'traa_add_some_classes', // Add classes through a callback.
	...
	$cmb_demo->add_field( array(
		...
		'id'         => 'traa_demo_text',
		'type'       => 'text',
		'show_on_cb' => 'traa_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'traa_display_text_small_column', // Output the display of the column values through a callback.
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'traa_demo_textmedium',
		'type' => 'text_medium',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'traa_demo_render_row_cb',
		'type' => 'text',
		'render_row_cb' => 'traa_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'traa_demo_textdate_timestamp',
		'type' => 'text_date_timestamp',
		// 'timezone_meta_key' => 'traa_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'traa_demo_datetime_timestamp',
	...
	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
	// 	'id'   => 'traa_demo_datetime_timestamp_timezone',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'traa_demo_text_taxonomy_radio',
	...
	$cmb_demo->add_field( array(
		...
		'id'           => 'traa_demo_parameters',
		'type'         => 'text',
		'before_row'   => 'traa_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'traa_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function traa_register_about_page_metabox() {

	/**
	 * Metabox to be displayed on a single page ID
	 */
	$cmb_about_page = new_cmb2_box( array(
		'id'           => 'traa_about_metabox',
...
add_action( 'cmb2_admin_init', 'traa_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function traa_register_repeatable_group_field_metabox() {

	/**
	 * Repeatable Field Groups
	 */
	$cmb_group = new_cmb2_box( array(
		'id'           => 'traa_group_metabox',
		'title'        => esc_html__( 'Repeating Field Group', 'cmb2' ),
		'object_types' => array( 'page' ),
	) );

	// $group_field_id is the field id string, so in this case: 'traa_group_demo'
...
add_action( 'cmb2_admin_init', 'traa_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function traa_register_user_profile_metabox() {
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'traa_user_user_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'traa_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function traa_register_taxonomy_metabox() {
	...
	$cmb_term->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'traa_term_term_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'traa_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function traa_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'traa_theme_options_page',
		...
		'option_key'      => 'traa_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'              => 'traa_options_page_message_callback',
 ...
 * }
 */
function traa_options_page_message_callback( $cmb, $args ) {
 ...
 */
function traa_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'traa_register_rest_api_box' );
/**
 ...
 */
function traa_register_rest_api_box() {
	$cmb_rest = new_cmb2_box( array(
		'id'            => 'traa_rest_metabox',
		...
		// 'get_box_permissions_check_cb' => 'traa_limit_rest_view_to_logged_in_users',
	) );
